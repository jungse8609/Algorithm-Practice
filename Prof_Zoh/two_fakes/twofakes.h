...
void load_coins() {
    in = fopen("C:\\Users\\jungs\\local_repo\\Alogorithm-Practice\\Prof_Zoh\\two_fakes\\sample_data\\temp.inp", "r");
    fscanf(in, "%11s", input);
...
void two_fakes(int idx1, int idx2) {
    out = fopen("C:\\Users\\jungs\\local_repo\\Alogorithm-Practice\\Prof_Zoh\\two_fakes\\sample_data\\temp.out", "w");
